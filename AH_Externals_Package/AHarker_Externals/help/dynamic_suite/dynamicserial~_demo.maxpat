{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 51.0, 127.0, 696.0, 369.0 ],
		"bglocked" : 0,
		"defrect" : [ 51.0, 127.0, 696.0, 369.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 512.0, 71.0, 76.0, 20.0 ],
					"text" : "svf~ 600 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 512.0, 125.0, 92.0, 20.0 ],
					"text" : "dynamic.out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 627.0, 74.0, 27.0, 95.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 512.0, 17.0, 85.0, 20.0 ],
					"text" : "dynamic.in~ 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 521.5, 61.5, 636.5, 61.5 ],
					"source" : [ "obj-16", 0 ]
				}
