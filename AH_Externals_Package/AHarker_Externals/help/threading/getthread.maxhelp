...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 270.0, 225.0, 66.0, 23.0 ],
									"text" : "getthread"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 270.0, 195.0, 126.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 270.0, 166.0, 54.0, 22.0 ],
									"text" : "jit.qfaker"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 120.0, 270.0, 52.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 120.0, 225.0, 66.0, 23.0 ],
									"text" : "getthread"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 30.0, 270.0, 52.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 30.0, 225.0, 66.0, 23.0 ],
									"text" : "getthread"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 30.0, 120.0, 129.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 120.0, 195.0, 126.0, 23.0 ],
									"text" : "jit.bfg 1 float32 2 2 1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.0, 15.0, 210.0, 50.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 39.5, 153.75, 279.5, 153.75 ],
									"order" : 0,
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 39.5, 153.5, 129.5, 153.5 ],
									"order" : 1,
									"source" : [ "obj-2", 0 ]
								}
...
,
					"patching_rect" : [ 150.0, 15.0, 25.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 195.0, 195.0, 66.0, 23.0 ],
									"text" : "getthread"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 30.0, 240.0, 52.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 30.0, 150.0, 136.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 195.0, 150.0, 129.0, 23.0 ],
									"text" : "metro 200 @active 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 30.0, 195.0, 66.0, 23.0 ],
									"text" : "getthread"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 270.0, 314.0, 55.0 ],
									"text" : "outputs a 0 for messages in the main (low priority) thread and 1 for those in the high priority thread.",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.0, 15.0, 540.0, 105.0 ]
								}
