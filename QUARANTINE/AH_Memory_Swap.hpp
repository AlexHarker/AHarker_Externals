...
typedef void *(*alloc_method) (size_t size, size_t nom_size);
...
static __inline bool alloc_mem_swap(t_safe_mem_swap *mem_struct, size_t size, size_t nom_size)
{
	bool fail = false;
	...
	if (size)
		mem_struct->current_ptr = allocate_aligned<uint8_t>(size);
	else
...
static __inline void free_mem_swap(t_safe_mem_swap *mem_struct)
{
	...
	if (mem_struct->current_free)
	{
		if (mem_struct->current_free_method)
			...
			deallocate_aligned(mem_struct->current_ptr);
	}
	...
	if (mem_struct->new_free)
	{
		if (mem_struct->new_free_method)
			...
			deallocate_aligned(mem_struct->new_ptr);
	}
...
static __inline void *access_mem_swap(t_safe_mem_swap *mem_struct, size_t *nom_size)
{
	void *return_ptr;
...
static __inline void schedule_swap_mem_swap(t_safe_mem_swap *mem_struct, void *ptr, size_t nom_size)
{
	t_atom method_ptr;
...
static __inline void *schedule_grow_mem_swap(t_safe_mem_swap *mem_struct,  size_t size, size_t nom_size)
{
	t_atom method_ptr;
	...
	if ((mem_struct->current_size < nom_size) && (mem_struct->new_size < nom_size))
	{
		...
		mem_struct->new_ptr = return_ptr = allocate_aligned<uint8_t>(size);
...
static __inline void *schedule_equal_mem_swap(t_safe_mem_swap *mem_struct,  size_t size, size_t nom_size)
{
	t_atom method_ptr;
...
static __inline void *grow_mem_swap(t_safe_mem_swap *mem_struct,  size_t size, size_t nom_size)
{
	t_atom method_ptr;
...
static __inline bool alloc_mem_swap_custom(t_safe_mem_swap *mem_struct, alloc_method alloc_method_ptr, free_method free_method_ptr, size_t size, size_t nom_size)
{
	bool fail = false;
...
static __inline void *schedule_grow_mem_swap_custom(t_safe_mem_swap *mem_struct, alloc_method alloc_method_ptr, free_method free_method_ptr, size_t size, size_t nom_size)
{
	t_atom method_ptr;
...
static __inline void *schedule_equal_mem_swap_custom(t_safe_mem_swap *mem_struct, alloc_method alloc_method_ptr, free_method free_method_ptr,  size_t size, size_t nom_size)
{
	t_atom method_ptr;
...
static __inline void *grow_mem_swap_custom(t_safe_mem_swap *mem_struct, alloc_method alloc_method_ptr, free_method free_method_ptr, size_t size, size_t nom_size)
{
	t_atom method_ptr;
