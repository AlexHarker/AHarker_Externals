...
,
					"patching_rect" : [ 35.0, 41.0, 47.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 196.0, 41.0, 183.0, 22.0 ],
...
,
					"patching_rect" : [ 87.0, 41.0, 101.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-25::obj-16" : [ "live.gain~[2]", "live.gain~", 0 ],
			"obj-42::obj-34" : [ "live.gain~[1]", "live.gain~", 0 ],
