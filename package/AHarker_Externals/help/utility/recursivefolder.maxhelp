...
,
					"patching_rect" : [ 60.0, 11.0, 25.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-6",
									"ignoreclick" : 1,
									"jsarguments" : [ "recursivefolder", 5 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 292.0, 270.0, 204.581497192382812, 54.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-4",
									"ignoreclick" : 1,
									"jsarguments" : [ "recursivefolder", 150 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.0, 15.0, 800.0, 120.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 180.0, 465.0, 138.0, 23.0 ],
									"text" : "print start_of_a_folder"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 330.0, 465.0, 134.0, 23.0 ],
									"text" : "print end_of_a_folder"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 480.0, 465.0, 122.0, 23.0 ],
									"text" : "print empty_folders"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 180.0, 420.0, 469.0, 23.0 ],
									"text" : "route start end empty"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 660.0, 465.0, 37.0, 23.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 265.0, 330.0, 53.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 180.0, 375.0, 499.0, 23.0 ],
									"text" : "route folder"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 630.0, 225.0, 80.0, 23.0 ],
									"text" : "types MooV"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 492.0, 225.0, 116.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 180.0, 270.0, 104.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 404.0, 225.0, 69.0, 23.0 ],
									"text" : "types iLaX"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 300.0, 225.0, 78.0, 23.0 ],
									"text" : "types JSON"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 210.0, 225.0, 76.0, 23.0 ],
									"text" : "types TEXT"
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 501.5, 258.5, 189.5, 258.5 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-18", 0 ],
									"midpoints" : [ 413.5, 258.5, 189.5, 258.5 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-18", 0 ],
									"midpoints" : [ 309.5, 258.5, 189.5, 258.5 ],
									"source" : [ "obj-20", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-18", 0 ],
									"midpoints" : [ 219.5, 258.5, 189.5, 258.5 ],
									"source" : [ "obj-21", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-18", 0 ],
									"midpoints" : [ 639.5, 258.5, 189.5, 258.5 ],
									"source" : [ "obj-31", 0 ]
								}
...
,
					"patching_rect" : [ 8.0, 11.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
