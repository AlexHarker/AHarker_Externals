...
,
					"patching_rect" : [ 58.0, 9.0, 25.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-4",
									"ignoreclick" : 1,
									"jsarguments" : [ "denormkiller~", 78 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 15.0, 15.0, 480.0, 118.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 150.0, 150.0, 91.0, 23.0 ],
									"text" : "denormkiller~"
								}
...
,
					"patching_rect" : [ 7.0, 9.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
