...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-17",
					"ignoreclick" : 1,
					"jsarguments" : [ "dynamic.patch~", 5 ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 131.0, 90.0, 178.9844970703125, 39.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 15.0, 150.0, 45.0, 23.0 ],
					"text" : "* 235."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 106.0, 150.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 15.0, 90.0, 114.0, 23.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 129.5, 79.0, 24.5, 79.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 24.5, 128.0, 115.5, 128.0 ],
					"order" : 0,
					"source" : [ "obj-8", 0 ]
				}
