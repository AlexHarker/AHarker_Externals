{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 140.0, 151.0, 585.0, 300.0 ],
		"bglocked" : 0,
		"defrect" : [ 140.0, 151.0, 585.0, 300.0 ],
...
,
					"patching_rect" : [ 495.0, 208.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 200.0, 393.0, 86.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 143.0, 374.0, 46.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 106.0, 83.0, 20.0 ],
					"text" : "denormkiller~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.0, 237.0, 55.0, 20.0 ],
					"text" : "autohelp"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Prevent CPU spiking from poor denrom handling",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "denormkiller~ can remedy CPU spikes from third party audio objects that are due to poor or no denormal handling. One object per audio thread is required.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 313.01062, 22.0, 186.989365, 14.666666 ],
					"presentation_rect" : [ 0.0, 0.0, 186.989365, 14.666666 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
					"text" : "open denormkiller~ reference",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 439.0, 241.0, 100.0, 20.0 ],
					"text" : "See Also:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 439.0, 261.0, 130.0, 20.0 ],
					"types" : [  ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.0, 237.0, 140.0, 50.0 ],
