...
static __inline t_sndfile_error sndfile_seek(t_sndfile *file, size_t frames)
{
...
static __inline long sndfile_read_interleaved_double(t_sndfile *file, double *output, size_t nframes)
{
    return sndfile_read_double(file, output, nframes, -1);
}

static __inline long sndfile_read_channel_double(t_sndfile *file, double *output, size_t nframes, unsigned int channel)
{
...
static __inline long sndfile_read_interleaved_float(t_sndfile *file, float *output, size_t nframes)
{
    return sndfile_read_float(file, output, nframes, -1);
}

static __inline long sndfile_read_channel_float(t_sndfile *file, float *output, size_t nframes, unsigned int channel)
{
