...
public:
    ...
    struct read_pointer
    {
        read_pointer(const EntryDatabase *ptr) : m_ptr(ptr)  { m_ptr->m_lock.acquire_read(); }
    ...
    EntryDatabase(t_symbol *name, long num_columns)
...
private:
    ...
    {
        read_write_pointer(const EntryDatabase *ptr)
