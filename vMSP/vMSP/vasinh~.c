...
#define OBJNAME_STR "vasinh~"
#define OBJNAME_FIRST(a) vasinh ## a
#define OBJNAME_SECOND(a) a ## vasinh

// Define 32 bit operations (N.B. the vector operations may in fact be undefined -dealt with below)

#define F32_VEC_OP F32_VEC_ASINH_OP
#define F32_VEC_ARRAY F32_VEC_ASINH_ARRAY
#define F32_SCALAR_OP asinhf

// Define 64 bit operations (N.B. the vector operations may in fact be undefined -dealt with below)

#define F64_VEC_OP F64_VEC_ASINH_OP
#define F64_VEC_ARRAY F64_VEC_ASINH_ARRAY
#define F64_SCALAR_OP asinh 

// Check for the existence of 32 bit vector operations and set correct approach (by vector / array / scalar fallback)

#ifndef F32_VEC_ASINH_OP
#ifdef F32_VEC_ASINH_ARRAY
...
#ifndef F64_VEC_ASINH_OP
#ifdef F64_VEC_ASINH_ARRAY
