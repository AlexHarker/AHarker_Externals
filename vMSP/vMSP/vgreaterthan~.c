...
#define OBJNAME_STR "vgreaterthan~"
#define OBJNAME_FIRST(a) vgreaterthan ## a
#define OBJNAME_SECOND(a) a ## vgreaterthan

// Define operations (all intrinsic-based)

#define F32_VEC_OP			F32_VEC_GT_MSP_OP
#define F32_SCALAR_OP(a,b)	(a > b)

#define F64_VEC_OP			F64_VEC_GT_MSP_OP
