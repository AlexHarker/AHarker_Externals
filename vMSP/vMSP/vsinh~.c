...
#define OBJNAME_STR "vsinh~"
#define OBJNAME_FIRST(a) vsinh ## a
#define OBJNAME_SECOND(a) a ## vsinh

// Define 32 bit operations (N.B. the vector operations may in fact be undefined -dealt with below)

#define F32_VEC_OP F32_VEC_SINH_OP
#define F32_VEC_ARRAY F32_VEC_SINH_ARRAY
#define F32_SCALAR_OP sinhf

// Define 64 bit operations (N.B. the vector operations may in fact be undefined -dealt with below)

#define F64_VEC_OP F64_VEC_SINH_OP
#define F64_VEC_ARRAY F64_VEC_SINH_ARRAY
#define F64_SCALAR_OP sinh

// Check for the existence of 32 bit vector operations and set correct approach (by vector / array / scalar fallback)

#ifndef F32_VEC_SINH_OP
#ifdef F32_VEC_SINH_ARRAY
...
#ifndef F64_VEC_SINH_OP
#ifdef F64_VEC_SINH_ARRAY
